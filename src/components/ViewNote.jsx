...
function ViewNote({ viewNoteData, setViewNoteData, refetch }) {
    ...
    return (
        <div>
            ...
            <label for='viewNote' onClick={() => setViewNoteData("")} class="modal dark:bg-[#1e1e26ed]  modal-bottom sm:modal-middle">
                <label for='' onClick={e => e.stopPropagation()} class="modal-box bg-[#F0F0F1] text-gray-900 dark:bg-[#1b2129] dark:text-[#a5a2a2] md:text-[18px] text-[12px]  text-[#abaaaa] font-extralight md:leading-[38px] dark:text-white">
